/*
	...
	Popis zadania:
		Riešenie je aplikácia ako Strava, Endomondo alebo Runkeeper - aplikácia, kde si užívatelia zaznamenávajú svoje športové aktivity.
		Je možné zaznamenáva viacero druhov aktivít (beh, cyklistika, plávanie...), ïalej sa užívatelia mohli priateli, 
		takže môžu vidie aktivity svojich priate¾ov a je možné organizova výzvy - challenges, do ktorých sa môže ktoko¾vek zapoji, 
		majú nejaký cie¾ a víaz by mohol obdrža nejakú odmenu.
*/
